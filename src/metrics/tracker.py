...
class MetricTracker:
    ...
    def __init__(self, *keys: str) -> None:
        ...
        *keys : str
        ...
        self._data = pd.DataFrame(index=keys, columns=['total', 'counts', 'average'])  # ty: ignore[invalid-argument-type]
    ...
    def update(self, key: str, value: float) -> None:
        """
        Update metrics DataFrame with new value and compute EMA for loss metrics.
